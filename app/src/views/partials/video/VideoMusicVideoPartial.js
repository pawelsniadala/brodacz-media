    ...
    <div className="video-wedding-partial">
        <section className="presentation-section">
            <div className="section-wrapper">
                <CardPresentation
                    cardDescriptopm={video.presentation.musicVideo.description}
                    cardImg={video.presentation.musicVideo.image}
                />
            </div>
        </section>
        <section className="realization-section">
            <div className="section-wrapper">
                ...
                <div className="card-wrapper realization video">
                    {video.realization.musicVideo.length ? video.realization.musicVideo.map((item) => (
                        <CardRealization
                            cardVideo
                            key={item.id}
