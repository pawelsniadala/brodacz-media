...
const WykorzystanieWideoWKampaniachReklamowychNaFacebooku = ({ content }) => {
    return (
        <>
            ...
            <Box className='box'>
                <Image
                    imageSrc={content.images[1].src}
                    imageAlt={content.images[1].alt}
                    imageAuthor={content.images[1].author}
                    imageHref={content.images[1].href}
                />
            </Box>
            <Box className='box'>
                <Typography variant='h4' className='header'>
