...
export const music = [
    {
        ...
        company: 'Kurp',
        video: { time: '3:58', src: videoMusicThumbnail1, urlPage: 'https://www.youtube.com/watch?v=OTy97M9OTeE' }
    },
    {
        display: true,
        ...
        video: { time: '2:40', src: videoMusicThumbnail2, urlPage: 'https://www.youtube.com/watch?v=_XSvz3Ym65A' }
    },
    {
        display: true,
        ...
        video: { time: '0:39', src: videoMusicThumbnail3, urlPage: 'https://www.youtube.com/watch?v=j3DRt_7Yt10' }
    }
];
