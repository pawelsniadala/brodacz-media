        ...
        <footer>
            ...
            <Box className='section-wrapper info'>
                <Box className='copyright'>
                    ...
                    <Box>
                        Photos designed by Mariusz Śniadała. Design by <a href='https://www.linkedin.com/in/pawelsniadala/' className='design' target='_blank' rel='noreferrer'>Paweł Śniadała</a>.
                    </Box>
                </Box>
            </Box>
        </footer>
